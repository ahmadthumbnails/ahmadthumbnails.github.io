// Your portfolio. One block per thumbnail.
// The order here is the order on the site, so put your best or newest work first.
//
// To add a thumbnail:
//   1. Put the image in images/thumbnails/
//   2. Copy one block below, paste it where you want it, and change the values
//
// Fields:
//   title  the video title shown under the thumbnail
//   image  path to the image file
//   tags   one or more tags. Each tag becomes a filter button on the site.
//   link   optional YouTube link. Adds a "Watch video" button when opened. Use "" to skip.
